import { o as objectType, h as dateType, n as numberType, i as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, j as escape, k as renderUniqueStylesheet, l as renderScriptElement, p as createHeadAndContent, r as renderComponent } from './astro/server_qtT_TmK9.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CWM1yCSY.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BlO8Olzo.mjs').then(n => n._);
