import { b as createAstro, c as createComponent, m as maybeRenderHead, g as addAttribute, r as renderComponent, a as renderTemplate, d as renderSlot } from './astro/server_qtT_TmK9.mjs';
import { a as $$FormattedDate } from './FormattedDate_BaPYkBYD.mjs';
import { g as getCollection } from './_astro_content_LJGOAL2r.mjs';
...
const $$ArticleDisplay = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Card", $$Card, { "parentClass": "w-full", "class": "space-y-4" }, { "default": ($$result2) => renderTemplate`    ${maybeRenderHead()}<div class="w-full"> <ul> ${posts.map((post) => renderTemplate`${renderComponent($$result2, "ArticleLink", $$ArticleLink, { "post": post })}`)} </ul> </div> ${home && renderTemplate`<a href="/blog" class="text-white font-mono font-bold no-underline hover:text-sky-400 text-base hover:underline">
view my writings
</a>`}` })}`;
